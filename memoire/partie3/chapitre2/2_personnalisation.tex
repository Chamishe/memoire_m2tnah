...
\end{itemize}
Ces filtres correspondent aux champs trouvés dans les différents types de traitement documentaire. Les résultats fourniront en conséquence les notices pour lesquels ces champs contiennent des données sans qu'il n'ait à intégrer que cela correspond à tel type de notices. 
